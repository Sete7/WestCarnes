<!------------------------------------------------------------------BANNER PAGE QUEM SOMOS----------------------------------------->
<section class="banner container">
    <h1 class="font-zero">Quem Somos</h1>
    <article class="box_quem_somos"> 
        <h1 class="font-zero">Familia West Carnes</h1> 
        <img class="img-desk"  src="<?= REQUIRE_PATH; ?>/img/banner/banner-quem-somos.jpg" alt="Banner Page WestCarnes"/>      
        <img class="img-mob" src="<?= REQUIRE_PATH; ?>/img/mobile/banner-mobi-quem.jpg" alt=""/>        
    </article>	
</section>

<!------------------------------------------------------------------CONTEUDO PAGE QUEM SOMOS----------------------------------------->
<main class="main_quem container">
    <section class="informe_quem">
        <h1 class="font-zero">Informe Quem Somos</h1>
        <article class="desc_quem_somos">
            <h1 class="font-zero">Missão, Visão e Valores.</h1>
            <div class="content">
                ...
                <div class="box_mais column column-4">
                    <div class="missao">
                        <h1>MISSÃO</h1>
                        <p>
